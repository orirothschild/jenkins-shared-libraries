...
class BitbucketStatus_NullBitbucketStatus_UndefinedBuildStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatus_NullBitbucketStatus_UndefinedBuildStatus_MapParams_Tests(String buildStatus){
