...
class BitbucketStatus_DefinedBuildStatus_InvalidBitbucketStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatus_DefinedBuildStatus_InvalidBitbucketStatus_MapParams_Tests(List list){
    ...
    @Test
    void test_BitbucketStatus_DefinedBuildStatus_InvalidBitbucketStatus_ErrorIsRaisedWithMessage(){
