...
class BitbucketStatus_UndefinedBuildStatus_InvalidBitbucketStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatus_UndefinedBuildStatus_InvalidBitbucketStatus_MapParams_Tests(List list){
