...
class BitbucketStatusFirstBuild_NullBitbucketStatus_UndefinedBuildStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatusFirstBuild_NullBitbucketStatus_UndefinedBuildStatus_MapParams_Tests(String buildStatus){
    ...
    @Test
    void test_BitbucketStatusFirstBuild_NullBitbucketStatus_UndefinedBuildStatus_bitbucketStatusNotifyIsNotExecuted(){
    ...
    @Test
    void test_BitbucketStatusFirstBuild_NullBitbucketStatus_UndefinedBuildStatus_httpRequestIsNotExecuted(){
        Helper.setBuildStatus(buildStatus, bitbucketStatus_)
    ...
    @Test
    void test_BitbucketStatusFirstBuild_NullBitbucketStatus_UndefinedBuildStatus_echoSentMessage(){
        Helper.setBuildStatus(buildStatus, bitbucketStatus_)
        def actualMessage = ""
