...
class DockerBuild_DefaultDockerfileDefaultImageName_MapParams_Tests extends GroovyTestCase {
	...
	DockerBuild_DefaultDockerfileDefaultImageName_MapParams_Tests(List list){
        this.path = list[0]
