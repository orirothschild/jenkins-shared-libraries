...
class BitbucketStatus_UndefinedBuildStatus_ValidBitBucketStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatus_UndefinedBuildStatus_ValidBitBucketStatus_MapParams_Tests(List list){
