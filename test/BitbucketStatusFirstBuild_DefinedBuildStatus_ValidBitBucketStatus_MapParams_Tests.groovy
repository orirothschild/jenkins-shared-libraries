...
class BitbucketStatusFirstBuild_DefinedBuildStatus_ValidBitBucketStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatusFirstBuild_DefinedBuildStatus_ValidBitBucketStatus_MapParams_Tests(List list){
