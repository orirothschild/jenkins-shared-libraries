...
class BitbucketStatusFirstBuild_NullBitbucketStatus_DefinedBuildStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatusFirstBuild_NullBitbucketStatus_DefinedBuildStatus_MapParams_Tests(String buildStatus){
