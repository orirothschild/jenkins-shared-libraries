...
class GitlabStatusHTTPS_CommonTests extends GroovyTestCase {
	...
	GitlabStatusHTTPS_CommonTests(String jenkinsStatus, String gitlabState) {
    ...
    void setUp() {
        ...
        InjectVars.injectClosureTo(gitlabStatus_, 'sh', ShellTestData.getShellClosureHTTPS())
