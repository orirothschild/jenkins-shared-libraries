...
class DockerPush_CustomImageName_MapParams_Tests extends GroovyTestCase {
	...
	DockerPush_CustomImageName_MapParams_Tests(String imageName){
    ...
    void test_DockerPushLatest_checkOrderOfCommands(){
        ...
        def expectedShellCommands = [
                ...
                "docker push \"registry.com/bilderlings/${imageName}:111111122222222222222222\"".toString(),
