...
class BitbucketStatus_DefinedBuildStatus_InvalidBitbucketStatus_Tests extends GroovyTestCase {
    ...
    BitbucketStatus_DefinedBuildStatus_InvalidBitbucketStatus_Tests(List list){
