...
class BitbucketStatusFirstBuild_UndefinedBuildStatus_InvalidBitbucketStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatusFirstBuild_UndefinedBuildStatus_InvalidBitbucketStatus_MapParams_Tests(List list){
    ...
    @Test
    void test_BitbucketStatusFirstBuild_UndefinedBuildStatus_InvalidBitbucketStatus_ErrorIsRaisedWithMessage(){
    ...
    @Test
    void test_BitbucketStatusFirstBuild_UndefinedBuildStatus_InvalidBitbucketStatus_bitbucketStatusNotifyIsNotExecuted(){
        Helper.setBuildStatus(buildStatus, bitbucketStatus_)
    ...
    @Test
    void test_BitbucketStatusFirstBuild_UndefinedBuildStatus_InvalidBitbucketStatus_httpRequestIsNotExecuted(){
        Helper.setBuildStatus(buildStatus, bitbucketStatus_)
