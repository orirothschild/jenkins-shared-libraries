...
class BitbucketStatusFirstBuild_UndefinedBuildStatus_ValidBitBucketStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatusFirstBuild_UndefinedBuildStatus_ValidBitBucketStatus_MapParams_Tests(List list){
