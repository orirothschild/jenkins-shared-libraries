...
class BitbucketStatusFirstBuild_DefinedBuildStatus_InvalidBitbucketStatus_Tests extends GroovyTestCase {
    ...
    BitbucketStatusFirstBuild_DefinedBuildStatus_InvalidBitbucketStatus_Tests(List list){
