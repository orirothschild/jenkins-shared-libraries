...
class BitbucketStatus_DefinedBuildStatus_ValidBitBucketStatus_MapParams_Tests extends GroovyTestCase {
	...
	BitbucketStatus_DefinedBuildStatus_ValidBitBucketStatus_MapParams_Tests(List list){
